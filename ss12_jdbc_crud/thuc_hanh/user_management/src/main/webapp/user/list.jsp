                ...
                <tr class="text-center">
                    ...
                    <td>
                        <div class="w-100 d-flex float-left">
                            ...
                            <button class="btn btn-danger w-50 " data-toggle="modal" data-target="#exampleModal" >Xóa</button>
                        </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-danger" href="users?action=delete&id=${user.getId()}">Xóa</a>
                            </div>
                        </div>
                    </div>
                </div>
